...
public class SearchPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phonenumb = findViewById(R.id.Pnum);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) { // if data exist/received, no error with phonenum
                    ...
                    if (ID.equals(Identification)) {
                        ...
                        Toast.makeText(SearchPatient.this, "ID does not match!", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(SearchPatient.this, "No such user exist!", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SearchPatient.this, error.getMessage(), Toast.LENGTH_LONG).show(); //show the error with a toast notification
            }
        });
    }
